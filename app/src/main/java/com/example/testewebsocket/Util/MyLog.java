...
public class MyLog {
    ...
    public void showD(@NonNull String method, @NonNull List<?> data){
        int size = data.size();
        StringBuilder msg = new StringBuilder();

        for (int i = 0 ; i < size ; i++){
            if(i+1 == size)
                msg.append(data.get(i).toString());
            else
                msg.append(data.get(i).toString()).append(", ");
        }
    ...
    public void showD(@NonNull String method, @NonNull String identifier, @NonNull List<?> data){
        int size = data.size();
        StringBuilder msg = new StringBuilder();
